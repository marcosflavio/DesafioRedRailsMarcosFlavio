...
~~~REDWITTER~~~
<font face="verdana" color="red"> REDWITTER </font>
...
Foi utilizada também a classe Jumbotron para o painel header, retirado de http://getbootstrap.com/components/#jumbotron
